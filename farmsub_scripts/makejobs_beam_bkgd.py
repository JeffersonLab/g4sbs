...
# More specifically, this script submit jobs with beam on target generator
# Example: to run beam on target in the gep configuration (script gep12_beam_bkgd.mac), type:
# > python2 makejobs_beam_bkgd.py gep12_beam_bkgd.mac 10 
...
# > python2 makejobs_beam_bkgd.py gep12_beam_bkgd.mac 10 preinit_ckov_noscint.mac 
...
for i in range(0, int(sys.argv[2])):
    ...
    runfile.write("mv beam_bkgd.root /volatile/your_/path_/to_/your_/output_/"+suffix2+"/beam_bkgd_"+suffix3+".root\n")
