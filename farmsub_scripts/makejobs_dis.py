...
# More specifically, this script submit jobs with dis generator
# Example: to run dis generated electrons in the nDVCS configuration (script ndvcs_dis.mac), type:
# > python2 makejobs_dis.py ndvcs_dis.mac 10 
