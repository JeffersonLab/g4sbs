...
# More specifically, this script submit jobs with elastic generator
# Example: to run elastic ep in the gep configuration (script gep12_elastic_sig.mac), type:
# > python2 makejobs_elastic_sig.py gep12_elastic_sig.mac 10 
...
# > python2 makejobs_elastic_sig.py gep12_elastic_sig.mac 10 preinit_ckov_noscint.mac 
...
for i in range(0, int(sys.argv[2])):
    ...
    runfile.write("mv elastic.root /volatile/your_/path_/to_/your_/output_/"+suffix2+"/elastic_"+suffix3+".root\n")
