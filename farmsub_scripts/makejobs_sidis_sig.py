...
# More specifically, this script submit jobs with sidis generator
# Example: to run pi+s generated with sidis in the sidis configuration (script sidis_sidis_pip_sig.mac), type:
# > python2 makejobs_sidis_bkgd.py sidis_sidis_pip_sig.mac 10 
...
# > python2 makejobs_sidis_bkgd.py sidis_sidis_pip_sig.mac 10 preinit_ckov_noscint.mac 
...
for i in range(0, int(sys.argv[2])):
    ...
    runfile.write("mv sidis_sig.root /volatile/your_/path_/to_/your_/output_/"+suffix2+"/sidis_sig_"+suffix3+".root\n")
