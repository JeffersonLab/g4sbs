...
# More specifically, this script submit jobs with wiser generator
# Example: to run pi0s generated with wiser in the nDVCS configuration (script ndvcs_wiser_pi0.mac), type:
# > python2 makejobs_wiser_bkgd.py ndvcs_wiser_pi0.mac 10 
# for 10 jobs (obviously, any number of jobs between 1 and a reasonable-ish number -a few 1000s- is good)
# if one wants to include a preinit script (e.g preinit_ckov_noscint.mac to turn off scintillation), type:
# > python2 makejobs_wiser_bkgd.py ndvcs_wiser_pi0.mac 10 preinit_ckov_noscint.mac 
...
for i in range(0, int(sys.argv[2])):
    ...
    runfile.write("mv wiser_bkgd.root /volatile/your_/path_/to_/your_/output_/"+suffix2+"/wiser_bkgd_"+suffix3+".root\n")
# NB: it is important that the name of the root file you produce (in your .mac file) is the same as the first file name in the previous line
# If not, your output file will be lost.
