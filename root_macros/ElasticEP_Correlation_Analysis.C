...
void ElasticEP_Correlation_Analysis(const char *inputfilename, const char *outputfilename="temp.root"){
  ...
  TH1D *hdpp = new TH1D("hdpp","",250,-0.1,0.1); //fraction of p
  TH1D *hdptheta = new TH1D("hdptheta","",250,-0.01,0.01); //radians
  TH1D *hdpphi   = new TH1D("hdpphi","",250,-0.03,0.03);
  TH1D *hpmissp = new TH1D("hpmissp","",250,-500.0,500.0); //MeV
  ...
  TH2D *hxyclust = new TH2D("hxyclust","",200,-0.75,0.75,200,-1.75,1.75); //m
  TH1D *hEclust = new TH1D("hEclust","",200,0.0,6.0);
  TH2D *hEclust_vs_Etrue = new TH2D("hEclust_vs_Etrue","",200,0.0,6.0,200,0.0,6.0);
  TH1D *hdEclust_fractional = new TH1D("hdEclust_fractional","",200,-1.0,1.0);
  TH2D *hdEclust_fractional_vs_Eclust = new TH2D("hdEclust_fractional_vs_Eclust","",200,0.0,6.0,200,-1.0,1.0);
  TH1D *hnhitclust = new TH1D("hnhitclust","",50,0.5,50.5);
  TH1D *hdxclust = new TH1D("hdxclust","",200,-10.,10.); //cm, xclust - x "true"
  TH1D *hdyclust = new TH1D("hdyclust","",200,-10.,10.); //cm, yclust - y "true"
  TH1D *hxmom = new TH1D("hxmom","",200,-1.0,1.0);
  TH1D *hymom = new TH1D("hymom","",200,-1.0,1.0);
  TH2D *hdxx = new TH2D("hdxx","",300,-75.0,75.0,200,-10.,10.);
  TH2D *hdyy = new TH2D("hdyy","",700,-175.,175.,200,-10.,10.);
  ...
  TH2D *hxyclust_corrected = new TH2D("hxyclust_corrected","",200,-0.75,0.75,200,-1.75,1.75);
  TH1D *hdxclust_corrected = new TH1D("hdxclust_corrected","",200,-10.0,10.0);
  TH1D *hdyclust_corrected = new TH1D("hdyclust_corrected","",200,-10.0,10.0);

  TH2D *hdxx_corrected = new TH2D("hdxx_corrected","",300,-75.,75.,200,-10.,10.);
  TH2D *hdyy_corrected = new TH2D("hdyy_corrected","",700,-175.,175.,200,-10.,10.);

  TH1D *hxcorr_xmax = new TH1D("hxcorr_xmax","",300,-ECAL_max_cell_size,ECAL_max_cell_size);
  TH1D *hycorr_ymax = new TH1D("hycorr_ymax","",300,-ECAL_max_cell_size,ECAL_max_cell_size);
  
  //TH1D *hxcl_xmax_corr = new TH1D("hxcl_xmax_corr","",200,-ECAL_max_
  ...
  TH1D *hdy1_CDET_ECAL = new TH1D("hdy1_CDET_ECAL","",200,-0.05,.05);
  TH1D *hdy2_CDET_ECAL = new TH1D("hdy2_CDET_ECAL","",200,-0.05,.05);
  TH1D *hdy12_CDET = new TH1D("hdy12_CDET","",200,-0.05,.05);

  TH1D *hEtot1_CDET = new TH1D("hEtot1_CDET","",200,0.0,0.05);
  TH1D *hEtot2_CDET = new TH1D("hEtot2_CDET","",200,0.0,0.05);

  TH1D *hdEclust_Eprime_eth = new TH1D("hdEclust_Eprime_eth","",200,-1.0,1.0);
  TH1D *hdethc_Eclust = new TH1D("hdethc_Eclust","",200,-0.2,0.2);
  TH1D *hdethc_thtrue = new TH1D("hdethc_thtrue","",200,-0.03,0.03);
  TH2D *hdethc_thtrue_vs_z = new TH2D("hdethc_thtrue_vs_z","",200,-0.55*Ltgt,0.55*Ltgt,200,-.03,.03);
  TH1D *hdephc_phtrue = new TH1D("hdephc_phtrue","",200,-0.03,0.03);

  TH1D *hdxfp = new TH1D("hdxfp","",200,-0.1,0.1);
  TH1D *hdyfp = new TH1D("hdyfp","",200,-0.1,0.1);
  TH1D *hdxpfp = new TH1D("hdxpfp","",200,-0.02,0.02);
  TH1D *hdypfp = new TH1D("hdypfp","",200,-0.02,0.02);

  TH2D *hdxfp_vs_ztrue = new TH2D("hdxfp_vs_ztrue","",200,-0.55*Ltgt,0.55*Ltgt, 200, -0.1,0.1);
  TH2D *hdyfp_vs_ztrue = new TH2D("hdyfp_vs_ztrue","",200,-0.55*Ltgt,0.55*Ltgt, 200, -0.1,0.1);
  TH2D *hdxpfp_vs_ztrue = new TH2D("hdxpfp_vs_ztrue","",200,-0.55*Ltgt,0.55*Ltgt, 200, -0.02,0.02);
  TH2D *hdypfp_vs_ztrue = new TH2D("hdypfp_vs_ztrue","",200,-0.55*Ltgt,0.55*Ltgt, 200, -0.02,0.02);
  
  

  TH1D *hdpp_etheta_c = new TH1D("hdpp_etheta_c","",250,-0.2,0.2);
  TH1D *hdpp_eclust = new TH1D("hdpp_eclust","",250,-0.2,0.2);
  TH1D *hdpp_etheta_vtx_known = new TH1D("hdpp_etheta_vtx_known","",250,-0.2,0.2);

  TH1D *hdxfp_vtx_known = new TH1D("hdxfp_vtx_known","",250,-0.1,0.1);
  TH1D *hdyfp_vtx_known = new TH1D("hdyfp_vtx_known","",250,-0.1,0.1);
  TH1D *hdxpfp_vtx_known = new TH1D("hdxpfp_vtx_known","",250,-0.02,0.02);
  TH1D *hdypfp_vtx_known = new TH1D("hdypfp_vtx_known","",250,-0.02,0.02);

  //Finally, let's look at exclusivity cut variables computed from reconstructed electron arm and proton arm
  //quantities:

  TH1D *hdeltax_pth = new TH1D("hdeltax_pth","",200,-30.0,30.0);
  TH1D *hdeltay_pth = new TH1D("hdeltay_pth","",200,-30.0,30.0);
  TH2D *hdxdy_pth = new TH2D("hdxdy_pth","",200,-30.0,30.0,200,-30.0,30.0);

  
  TH1D *hdeltax_pp = new TH1D("hdeltax_pp","",200,-30.0,30.0);
  TH1D *hdeltay_pp = new TH1D("hdeltay_pp","",200,-30.0,30.0);
  TH2D *hdxdy_pp = new TH2D("hdxdy_pp","",200,-30.0,30.0,200,-30.,30.);

  // TH1D *hdeltax_4v = new TH1D("hdeltax_4v","",200,-30.,30.);
  // TH1D *hdeltay_4v = new TH1D("hdeltay_4v","",200,-30.,30.);
  // TH2D *hdxdy_4v = new TH2D("hdxdy_4v","",200,-30.,30.,200,-30.,30.);

  TH1D *hdphip = new TH1D("hdphip","",200,-0.02,0.02);
  TH1D *hdthetap = new TH1D("hdthetap","",200,-0.02,0.02);
  TH1D *hpmisse = new TH1D("hpmisse","",200,-0.1,0.1);
  TH1D *hdpp_eth_pth = new TH1D("hdpp_eth_pth","",200,-0.1,0.1);
  TH1D *hdthetae_true = new TH1D("hdthetae_true","",200,-0.02,0.02);
  TH1D *hdphie_true = new TH1D("hdphie_true","",200,-0.02,0.02);
  ...
  while( T->GetEntry(nevent++) ){
	...
	(*(T->Harm_FT_Track_MID))[0] == 0 ){
      double xfptemp = (*(T->Harm_FT_Track_Xfit))[0];
      double yfptemp = (*(T->Harm_FT_Track_Yfit))[0];
	...
	if( nplanes_fired == 2 ){
	  ...
	  hdeltax_pth->Fill( 100.*(xECAL - xclust_SBS) );
	  hdeltay_pth->Fill( 100.*(yECAL - yoff_ECAL - yclust_SBS) );
	  hdxdy_pth->Fill( 100.*(xECAL - xclust_SBS), 100.*(yECAL-yoff_ECAL - yclust_SBS) );
