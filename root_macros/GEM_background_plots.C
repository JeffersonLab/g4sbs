...
void GEM_background_plots( const char *rootfilename, const char *outputfilename ){
  ...
  gep_ntuple_nohistory *T = new gep_ntuple_nohistory(C);
  ...
  TH1D *hrate_layer_FT = new TH1D("hrate_layer_FT","",6,0.5,6.5);
  TH1D *hrate_layer_FPP1 = new TH1D("hrate_layer_FPP1","",5,0.5,5.5);
  TH1D *hrate_layer_FPP2 = new TH1D("hrate_layer_FPP2","",5,0.5,5.5);
  TH2D *hvx_vz_layer1_FT = new TH2D("hvx_vz_layer1_FT","",200,-1,7,200,-2,1);
  TH1D *hrate_vs_x_layer1_FT = new TH1D("hrate_vs_x_layer1_FT","",200,-.75,.75);
  TH1D *hrate_vs_y_layer1_FT = new TH1D("hrate_vs_y_layer1_FT","",200,-0.2,0.2);
  TH1D *hrate_vs_p_layer1_FT_wide = new TH1D("hrate_vs_p_layer1_FT_wide","",200,0.0,8.0);
  TH1D *hrate_vs_p_layer1_FT_zoom = new TH1D("hrate_vs_p_layer1_FT_zoom","",200,0.0,0.01);
  //TH1D *hrate_vs_p_electron_layer1_FT_wide = new TH1D("hrate_vs_p_electron_layer1_FT","",200,0.0,8.0);

  TH1D *hrate_vs_p_gamma_FT = new TH1D("hrate_vs_p_gamma_FT","",200,0.0,0.0002);
  TH1D *hrate_vs_p_electron_FT = new TH1D("hrate_vs_p_electron_FT","",200,0.0,.1);
  TH1D *hrate_vs_p_pion_FT = new TH1D("hrate_vs_p_pion_FT","",200,0.0,8.0);
  TH1D *hrate_vs_p_proton_FT = new TH1D("hrate_vs_p_proton_FT","",200,0.0,8.0);
  TH1D *hrate_vs_p_other_FT = new TH1D("hrate_vs_p_other_FT","",200,0.0,8.0);
  
  TH1D *hrate_vs_p_gamma_FPP1 = new TH1D("hrate_vs_p_gamma_FPP1","",200,0.0,.0002);
  TH1D *hrate_vs_p_electron_FPP1 = new TH1D("hrate_vs_p_electron_FPP1","",200,0.0,.1);
  TH1D *hrate_vs_p_pion_FPP1 = new TH1D("hrate_vs_p_pion_FPP1","",200,0.0,8.0);
  TH1D *hrate_vs_p_proton_FPP1 = new TH1D("hrate_vs_p_proton_FPP1","",200,0.0,8.0);
  TH1D *hrate_vs_p_other_FPP1 = new TH1D("hrate_vs_p_other_FPP1","",200,0.0,8.0);
  ...
  TH1D *hedep_FT = new TH1D("hedep_FT","",200,0.0,2e-5);
  TH1D *hedep_FPP1 = new TH1D("hedep_FPP1","",200,0.0,2e-5);
  ...
  TH2D *hvx_vz_FT = new TH2D("hvx_vz_FT","",200,-1,7,200,-2,1);
  ...
  TH2D *hvx_vz_FPP1 = new TH2D("hvx_vz_FPP1","",200,-1,7,200,-2,1);
  ...
  TH2D *hvy_vx_FT = new TH2D("hvy_vx_FT","",200,-3,3,200,-3,3);
  TH2D *hvy_vx_FPP1 = new TH2D("hvy_vx_FPP1","",200,-3,3,200,-3,3);
  TH2D *hvy_vx_FPP2 = new TH2D("hvy_vx_FPP2","",200,-3,3,200,-3,3);

  TH2D *hvy_vz_FT = new TH2D("hvy_vz_FT","",200,-1,7,200,-3,3);
  TH2D *hvy_vz_FPP1 = new TH2D("hvy_vz_FPP1","",200,-1,7,200,-3,3);
  TH2D *hvy_vz_FPP2 = new TH2D("hvy_vz_FPP2","",200,-1,7,200,-3,3);
  
  double weight = 75e-6/1.602e-19/double(nevents_generated);
  ...
  while( T->GetEntry(nevent++) ){
	...
	if( (*(T->Harm_FT_hit_plane))[hit]  == 1 ){
	  hvx_vz_layer1_FT->Fill( (*(T->Harm_FT_hit_vz))[hit], (*(T->Harm_FT_hit_vx))[hit], weight_FT );
	  hrate_vs_x_layer1_FT->Fill( (*(T->Harm_FT_hit_x))[hit], weight_FT*200.0);
	  hrate_vs_y_layer1_FT->Fill( (*(T->Harm_FT_hit_y))[hit], weight_FT*200.0);
	  hrate_vs_p_layer1_FT_wide->Fill( (*(T->Harm_FT_hit_p))[hit], weight_FT );
	  hrate_vs_p_layer1_FT_zoom->Fill( (*(T->Harm_FT_hit_p))[hit], weight_FT );
	}
	hrate_layer_FT->Fill( (*(T->Harm_FT_hit_plane))[hit], weight_FT );	
	if( (*(T->Harm_FT_hit_pid))[hit] == 22 ){ //gammas:
	  hrate_vs_p_gamma_FT->Fill( (*(T->Harm_FT_hit_p))[hit], weight_FT/nplanes[0] );
	} else if( abs( (*(T->Harm_FT_hit_pid))[hit] ) == 11 ){ //e+/e-
	  hrate_vs_p_electron_FT->Fill( (*(T->Harm_FT_hit_p))[hit], weight_FT/nplanes[0] );
	} else if( fabs( (*(T->Harm_FT_hit_pid))[hit] ) == 211 ){ //pi+/pi-
	  hrate_vs_p_pion_FT->Fill( (*(T->Harm_FT_hit_p))[hit], weight_FT/nplanes[0] );
	} else if( (*(T->Harm_FT_hit_pid))[hit] == 2212 ){ //protons
	  hrate_vs_p_proton_FT->Fill( (*(T->Harm_FT_hit_p))[hit], weight_FT/nplanes[0] );
	} else { //all others
	  hrate_vs_p_other_FT->Fill( (*(T->Harm_FT_hit_p))[hit], weight_FT/nplanes[0] );
	}
	
	hedep_FT->Fill( (*(T->Harm_FT_hit_edep))[hit], weight_FT/nplanes[0] );
	if( abs( (*(T->Harm_FT_hit_pid))[hit] ) == 11 ){
	  hedep_FT_electron->Fill( (*(T->Harm_FT_hit_edep))[hit], weight_FT/nplanes[0] );
	} else {
	  hedep_FT_other->Fill( (*(T->Harm_FT_hit_edep))[hit], weight_FT/nplanes[0] );
	}
	//hedep_layer_FT->Fill( (*(T->Harm_FT_hit_plane))[hit], (*(T->Harm_FT_hit_edep))[hit], weight_FT );
	hedep_vs_p_FT->Fill( (*(T->Harm_FT_hit_p))[hit], (*(T->Harm_FT_hit_edep))[hit], weight_FT/nplanes[0] );
	
	hvx_vz_FT->Fill( (*(T->Harm_FT_hit_vz))[hit], (*(T->Harm_FT_hit_vx))[hit], weight_FT/nplanes[0] );
	hvy_vx_FT->Fill( (*(T->Harm_FT_hit_vx))[hit], (*(T->Harm_FT_hit_vy))[hit], weight_FT/nplanes[0] );
	hvy_vz_FT->Fill( (*(T->Harm_FT_hit_vz))[hit], (*(T->Harm_FT_hit_vy))[hit], weight_FT/nplanes[0] );
	  
      }

      for( int hit=0; hit<T->Harm_FPP1_hit_nhits; hit++ ){
	hrate_layer_FPP1->Fill( (*(T->Harm_FPP1_hit_plane))[hit], weight_FPP1 );
	
	if( (*(T->Harm_FPP1_hit_pid))[hit] == 22 ){ 
	  hrate_vs_p_gamma_FPP1->Fill( (*(T->Harm_FPP1_hit_p))[hit], weight_FPP1/nplanes[1] );
	} else if( abs( (*(T->Harm_FPP1_hit_pid))[hit] ) == 11 ){
	  hrate_vs_p_electron_FPP1->Fill( (*(T->Harm_FPP1_hit_p))[hit], weight_FPP1/nplanes[1] );
	} else if( abs( (*(T->Harm_FPP1_hit_pid))[hit] ) == 211 ){
	  hrate_vs_p_pion_FPP1->Fill( (*(T->Harm_FPP1_hit_p))[hit], weight_FPP1/nplanes[1] );
	} else if( (*(T->Harm_FPP1_hit_pid))[hit] == 2212 ){
	  hrate_vs_p_proton_FPP1->Fill( (*(T->Harm_FPP1_hit_p))[hit], weight_FPP1/nplanes[1] );
	} else {
	  hrate_vs_p_other_FPP1->Fill( (*(T->Harm_FPP1_hit_p))[hit], weight_FPP1/nplanes[1] );
	}

	hedep_FPP1->Fill( (*(T->Harm_FPP1_hit_edep))[hit], weight_FPP1/nplanes[1] );
	//hedep_layer_FPP1->Fill( (*(T->Harm_FPP1_hit_plane))[hit], (*(T->Harm_FPP1_hit_edep))[hit], weight_FPP1 );
	if( abs( (*(T->Harm_FPP1_hit_pid))[hit] ) == 11 ){
	  hedep_FPP1_electron->Fill( (*(T->Harm_FPP1_hit_edep))[hit], weight_FPP1/nplanes[1] );
	} else {
	  hedep_FPP1_other->Fill( (*(T->Harm_FPP1_hit_edep))[hit], weight_FPP1/nplanes[1] );
	}
	hedep_vs_p_FPP1->Fill( (*(T->Harm_FPP1_hit_p))[hit], (*(T->Harm_FPP1_hit_edep))[hit], weight_FPP1/nplanes[1] );

	hvx_vz_FPP1->Fill( (*(T->Harm_FPP1_hit_vz))[hit], (*(T->Harm_FPP1_hit_vx))[hit], weight_FPP1/nplanes[1] );
	hvy_vx_FPP1->Fill( (*(T->Harm_FPP1_hit_vx))[hit], (*(T->Harm_FPP1_hit_vy))[hit], weight_FPP1/nplanes[1] );
	hvy_vz_FPP1->Fill( (*(T->Harm_FPP1_hit_vz))[hit], (*(T->Harm_FPP1_hit_vy))[hit], weight_FPP1/nplanes[1] );
      }

      for( int hit=0; hit<T->Harm_FPP2_hit_nhits; hit++ ){
	hrate_layer_FPP2->Fill( (*(T->Harm_FPP2_hit_plane))[hit], weight_FPP2 );

	if( (*(T->Harm_FPP2_hit_pid))[hit] == 22 ){ 
	  hrate_vs_p_gamma_FPP2->Fill( (*(T->Harm_FPP2_hit_p))[hit], weight_FPP2/nplanes[2] );
	} else if( abs( (*(T->Harm_FPP2_hit_pid))[hit] ) == 11 ){
	  hrate_vs_p_electron_FPP2->Fill( (*(T->Harm_FPP2_hit_p))[hit], weight_FPP2/nplanes[2] );
	} else if( abs( (*(T->Harm_FPP2_hit_pid))[hit] ) == 211 ){
	  hrate_vs_p_pion_FPP2->Fill( (*(T->Harm_FPP2_hit_p))[hit], weight_FPP2/nplanes[2] );
	} else if( (*(T->Harm_FPP2_hit_pid))[hit] == 2212 ){ //proton
	  hrate_vs_p_proton_FPP2->Fill( (*(T->Harm_FPP2_hit_p))[hit], weight_FPP2/nplanes[2] );
	}else {
	  hrate_vs_p_other_FPP2->Fill( (*(T->Harm_FPP2_hit_p))[hit], weight_FPP2/nplanes[2] );
	}

	hedep_FPP2->Fill( (*(T->Harm_FPP2_hit_edep))[hit], weight_FPP2/nplanes[2] );
	//hedep_layer_FPP2->Fill( (*(T->Harm_FPP2_hit_plane))[hit], (*(T->Harm_FPP2_hit_edep))[hit], weight_FPP2 );
	if( abs( (*(T->Harm_FPP2_hit_pid))[hit] ) == 11 ){
	  hedep_FPP2_electron->Fill( (*(T->Harm_FPP2_hit_edep))[hit], weight_FPP2/nplanes[2] );
	} else {
	  hedep_FPP2_other->Fill( (*(T->Harm_FPP2_hit_edep))[hit], weight_FPP2/nplanes[2] );
	}
	hedep_vs_p_FPP2->Fill( (*(T->Harm_FPP2_hit_p))[hit], (*(T->Harm_FPP2_hit_edep))[hit], weight_FPP2/nplanes[2] );
	hvx_vz_FPP2->Fill( (*(T->Harm_FPP2_hit_vz))[hit], (*(T->Harm_FPP2_hit_vx))[hit], weight_FPP2/nplanes[2] );
	hvy_vx_FPP2->Fill( (*(T->Harm_FPP2_hit_vx))[hit], (*(T->Harm_FPP2_hit_vy))[hit], weight_FPP2/nplanes[2] );
	hvy_vz_FPP2->Fill( (*(T->Harm_FPP2_hit_vz))[hit], (*(T->Harm_FPP2_hit_vy))[hit], weight_FPP2/nplanes[2] );
      }
    }
  }
