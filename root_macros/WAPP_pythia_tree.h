...
// Tue Jun 16 11:40:12 2020 by ROOT version 6.20/04
// from TChain T/
//////////////////////////////////////////////////////////

#ifndef WAPP_pythia_tree_h
#define WAPP_pythia_tree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   WAPP_pythia_tree(TTree *tree=0);
   virtual ~WAPP_pythia_tree();
...
#ifdef WAPP_pythia_tree_cxx
WAPP_pythia_tree::WAPP_pythia_tree(TTree *tree) : fChain(0) 
{
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      ...
      chain->Add("WAPP_pythia_proton.root/T");
      tree = chain;
#endif // SINGLE_TREE
...
WAPP_pythia_tree::~WAPP_pythia_tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t WAPP_pythia_tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WAPP_pythia_tree::LoadTree(Long64_t entry)
{
...
void WAPP_pythia_tree::Init(TTree *tree)
{
...
Bool_t WAPP_pythia_tree::Notify()
{
...
void WAPP_pythia_tree::Show(Long64_t entry)
{
...
Int_t WAPP_pythia_tree::Cut(Long64_t entry)
{
...
#endif // #ifdef WAPP_pythia_tree_cxx
