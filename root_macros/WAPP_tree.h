...
#ifdef WAPP_tree_cxx
WAPP_tree::WAPP_tree(TTree *tree) : fChain(0) 
{
...
Int_t WAPP_tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t WAPP_tree::LoadTree(Long64_t entry)
{
...
void WAPP_tree::Init(TTree *tree)
{
...
void WAPP_tree::Show(Long64_t entry)
{
...
Int_t WAPP_tree::Cut(Long64_t entry)
{
