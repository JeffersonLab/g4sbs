...
public :
   ...
   Double_t        gen_Ebeam;
   Int_t           ht_ndata;
   Int_t           ht_gid[2000];   //[ht.ndata]
   Int_t           ht_trkrid[2000];   //[ht.ndata]
   Double_t        ht_x[2000];   //[ht.ndata]
   Double_t        ht_y[2000];   //[ht.ndata]
   Double_t        ht_z[2000];   //[ht.ndata]
   Double_t        ht_t[2000];   //[ht.ndata]
   Double_t        ht_vx[2000];   //[ht.ndata]
   Double_t        ht_vy[2000];   //[ht.ndata]
   Double_t        ht_vz[2000];   //[ht.ndata]
   Double_t        ht_dx[2000];   //[ht.ndata]
   Double_t        ht_dy[2000];   //[ht.ndata]
   Double_t        ht_p[2000];   //[ht.ndata]
   Int_t           ht_trid[2000];   //[ht.ndata]
   Int_t           ht_pid[2000];   //[ht.ndata]
   Int_t           ht_mid[2000];   //[ht.ndata]
   Double_t        ht_edep[2000];   //[ht.ndata]
   Double_t        ht_tx[2000];   //[ht.ndata]
   Double_t        ht_ty[2000];   //[ht.ndata]
   Double_t        ht_txp[2000];   //[ht.ndata]
   Double_t        ht_typ[2000];   //[ht.ndata]
   Int_t           hc_ndata;
   Double_t        hc_x[2000];   //[hc.ndata]
   Double_t        hc_y[2000];   //[hc.ndata]
   Double_t        hc_z[2000];   //[hc.ndata]
   Double_t        hc_e[2000];   //[hc.ndata]
   Double_t        hc_t[2000];   //[hc.ndata]
   Double_t        hc_vx[2000];   //[hc.ndata]
   Double_t        hc_vy[2000];   //[hc.ndata]
   Double_t        hc_vz[2000];   //[hc.ndata]
   Int_t           hc_trid[2000];   //[hc.ndata]
   Int_t           hc_mid[2000];   //[hc.ndata]
   Int_t           hc_pid[2000];   //[hc.ndata]
   Int_t           bc_ndata;
   Double_t        bc_x[2000];   //[bc.ndata]
   Double_t        bc_y[2000];   //[bc.ndata]
   Double_t        bc_z[2000];   //[bc.ndata]
   Double_t        bc_e[2000];   //[bc.ndata]
   Double_t        bc_t[2000];   //[bc.ndata]
   Double_t        bc_vx[2000];   //[bc.ndata]
   Double_t        bc_vy[2000];   //[bc.ndata]
   Double_t        bc_vz[2000];   //[bc.ndata]
   Int_t           bc_trid[2000];   //[bc.ndata]
   Int_t           bc_mid[2000];   //[bc.ndata]
   Int_t           bc_pid[2000];   //[bc.ndata]
   Int_t           ntracks;
