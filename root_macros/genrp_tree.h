...
// Thu Jun  4 09:41:58 2020 by ROOT version 6.18/00
// from TTree T/Geant4 SBS Simulation
// found on file: genrp_beam_job1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("genrp_beam_job1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("genrp_beam_job1.root");
      }
      f->GetObject("T",tree);
