...
// Sat Jul 11 17:55:31 2020 by ROOT version 6.20/04
// from TTree T/Geant4 SBS Simulation
// found on file: genrp_4.5GeV2_conf3.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("genrp_4.5GeV2_conf3.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("genrp_4.5GeV2_conf3.root");
      }
      f->GetObject("T",tree);
