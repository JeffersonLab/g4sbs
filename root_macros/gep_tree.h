...
// Fri Oct 16 10:00:14 2015 by ROOT version 5.34/32
// from TTree T/Geant4 SBS Simulation
// found on file: gep_12GeV2_pythia6_no_opticalphotons_job1.root
//////////////////////////////////////////////////////////
...
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gep_12GeV2_pythia6_no_opticalphotons_job1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gep_12GeV2_pythia6_no_opticalphotons_job1.root");
      }
      f->GetObject("T",tree);
