...
// Mon Feb  6 14:09:13 2023 by ROOT version 6.26/06
// from TTree T/Geant4 SBS Simulation
// found on file: ../../output/GEPSIM_FEB2023/BEAM/GEP12_job_987.root
//////////////////////////////////////////////////////////

#ifndef gep_tree_beam_h
#define gep_tree_beam_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   gep_tree_beam(TTree *tree=0);
   virtual ~gep_tree_beam();
...
#ifdef gep_tree_beam_cxx
gep_tree_beam::gep_tree_beam(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("../../output/GEPSIM_FEB2023/BEAM/GEP12_job_987.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("../../output/GEPSIM_FEB2023/BEAM/GEP12_job_987.root");
      }
      f->GetObject("T",tree);
...
gep_tree_beam::~gep_tree_beam()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gep_tree_beam::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gep_tree_beam::LoadTree(Long64_t entry)
{
...
void gep_tree_beam::Init(TTree *tree)
{
...
void gep_tree_beam::Show(Long64_t entry)
{
...
Int_t gep_tree_beam::Cut(Long64_t entry)
{
