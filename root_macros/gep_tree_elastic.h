...
// Sun Jul  9 15:32:31 2017 by ROOT version 6.08/02
// from TTree T/Geant4 SBS Simulation
// found on file: job_1_gep_12GeV2_ecal.root
//////////////////////////////////////////////////////////

#ifndef gep_tree_elastic_h
#define gep_tree_elastic_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   gep_tree_elastic(TTree *tree=0);
   virtual ~gep_tree_elastic();
...
#ifdef gep_tree_elastic_cxx
gep_tree_elastic::gep_tree_elastic(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("job_1_gep_12GeV2_ecal.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("job_1_gep_12GeV2_ecal.root");
      }
      f->GetObject("T",tree);
...
gep_tree_elastic::~gep_tree_elastic()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gep_tree_elastic::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gep_tree_elastic::LoadTree(Long64_t entry)
{
...
void gep_tree_elastic::Init(TTree *tree)
{
...
Bool_t gep_tree_elastic::Notify()
{
...
void gep_tree_elastic::Show(Long64_t entry)
{
...
Int_t gep_tree_elastic::Cut(Long64_t entry)
{
...
#endif // #ifdef gep_tree_elastic_cxx
