...
// Fri Feb  7 10:01:54 2020 by ROOT version 6.18/00
// from TTree T/Geant4 SBS Simulation
// found on file: gep_12GeV2_option1_60cm_job1.root
//////////////////////////////////////////////////////////

#ifndef gep_tree_option1_h
#define gep_tree_option1_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Int_t           Harm_FPP_hit_nhits;
   vector<int>     *Harm_FPP_hit_plane;
   vector<int>     *Harm_FPP_hit_strip;
   vector<double>  *Harm_FPP_hit_x;
   vector<double>  *Harm_FPP_hit_y;
   vector<double>  *Harm_FPP_hit_z;
   vector<double>  *Harm_FPP_hit_polx;
   vector<double>  *Harm_FPP_hit_poly;
   vector<double>  *Harm_FPP_hit_polz;
   vector<double>  *Harm_FPP_hit_t;
   vector<double>  *Harm_FPP_hit_trms;
   vector<double>  *Harm_FPP_hit_tmin;
   vector<double>  *Harm_FPP_hit_tmax;
   vector<double>  *Harm_FPP_hit_tx;
   vector<double>  *Harm_FPP_hit_ty;
   vector<double>  *Harm_FPP_hit_xin;
   vector<double>  *Harm_FPP_hit_yin;
   vector<double>  *Harm_FPP_hit_zin;
   vector<double>  *Harm_FPP_hit_xout;
   vector<double>  *Harm_FPP_hit_yout;
   vector<double>  *Harm_FPP_hit_zout;
   vector<double>  *Harm_FPP_hit_txp;
   vector<double>  *Harm_FPP_hit_typ;
   vector<double>  *Harm_FPP_hit_xg;
   vector<double>  *Harm_FPP_hit_yg;
   vector<double>  *Harm_FPP_hit_zg;
   vector<int>     *Harm_FPP_hit_trid;
   vector<int>     *Harm_FPP_hit_mid;
   vector<int>     *Harm_FPP_hit_pid;
   vector<double>  *Harm_FPP_hit_vx;
   vector<double>  *Harm_FPP_hit_vy;
   vector<double>  *Harm_FPP_hit_vz;
   vector<double>  *Harm_FPP_hit_p;
   vector<double>  *Harm_FPP_hit_edep;
   vector<double>  *Harm_FPP_hit_beta;
   Int_t           Harm_FPP_Track_ntracks;
   vector<int>     *Harm_FPP_Track_TID;
   vector<int>     *Harm_FPP_Track_PID;
   vector<int>     *Harm_FPP_Track_MID;
   vector<int>     *Harm_FPP_Track_NumHits;
   vector<int>     *Harm_FPP_Track_NumPlanes;
   vector<int>     *Harm_FPP_Track_NDF;
   vector<double>  *Harm_FPP_Track_Chi2fit;
   vector<double>  *Harm_FPP_Track_Chi2true;
   vector<double>  *Harm_FPP_Track_X;
   vector<double>  *Harm_FPP_Track_Y;
   vector<double>  *Harm_FPP_Track_Xp;
   vector<double>  *Harm_FPP_Track_Yp;
   vector<double>  *Harm_FPP_Track_T;
   vector<double>  *Harm_FPP_Track_P;
   vector<double>  *Harm_FPP_Track_Sx;
   vector<double>  *Harm_FPP_Track_Sy;
   vector<double>  *Harm_FPP_Track_Sz;
   vector<double>  *Harm_FPP_Track_Xfit;
   vector<double>  *Harm_FPP_Track_Yfit;
   vector<double>  *Harm_FPP_Track_Xpfit;
   vector<double>  *Harm_FPP_Track_Ypfit;
   ...
   TBranch        *b_Harm_FPP_hit_nhits;   //!
   TBranch        *b_Harm_FPP_hit_plane;   //!
   TBranch        *b_Harm_FPP_hit_strip;   //!
   TBranch        *b_Harm_FPP_hit_x;   //!
   TBranch        *b_Harm_FPP_hit_y;   //!
   TBranch        *b_Harm_FPP_hit_z;   //!
   TBranch        *b_Harm_FPP_hit_polx;   //!
   TBranch        *b_Harm_FPP_hit_poly;   //!
   TBranch        *b_Harm_FPP_hit_polz;   //!
   TBranch        *b_Harm_FPP_hit_t;   //!
   TBranch        *b_Harm_FPP_hit_trms;   //!
   TBranch        *b_Harm_FPP_hit_tmin;   //!
   TBranch        *b_Harm_FPP_hit_tmax;   //!
   TBranch        *b_Harm_FPP_hit_tx;   //!
   TBranch        *b_Harm_FPP_hit_ty;   //!
   TBranch        *b_Harm_FPP_hit_xin;   //!
   TBranch        *b_Harm_FPP_hit_yin;   //!
   TBranch        *b_Harm_FPP_hit_zin;   //!
   TBranch        *b_Harm_FPP_hit_xout;   //!
   TBranch        *b_Harm_FPP_hit_yout;   //!
   TBranch        *b_Harm_FPP_hit_zout;   //!
   TBranch        *b_Harm_FPP_hit_txp;   //!
   TBranch        *b_Harm_FPP_hit_typ;   //!
   TBranch        *b_Harm_FPP_hit_xg;   //!
   TBranch        *b_Harm_FPP_hit_yg;   //!
   TBranch        *b_Harm_FPP_hit_zg;   //!
   TBranch        *b_Harm_FPP_hit_trid;   //!
   TBranch        *b_Harm_FPP_hit_mid;   //!
   TBranch        *b_Harm_FPP_hit_pid;   //!
   TBranch        *b_Harm_FPP_hit_vx;   //!
   TBranch        *b_Harm_FPP_hit_vy;   //!
   TBranch        *b_Harm_FPP_hit_vz;   //!
   TBranch        *b_Harm_FPP_hit_p;   //!
   TBranch        *b_Harm_FPP_hit_edep;   //!
   TBranch        *b_Harm_FPP_hit_beta;   //!
   TBranch        *b_Harm_FPP_Track_ntracks;   //!
   TBranch        *b_Harm_FPP_Track_TID;   //!
   TBranch        *b_Harm_FPP_Track_PID;   //!
   TBranch        *b_Harm_FPP_Track_MID;   //!
   TBranch        *b_Harm_FPP_Track_NumHits;   //!
   TBranch        *b_Harm_FPP_Track_NumPlanes;   //!
   TBranch        *b_Harm_FPP_Track_NDF;   //!
   TBranch        *b_Harm_FPP_Track_Chi2fit;   //!
   TBranch        *b_Harm_FPP_Track_Chi2true;   //!
   TBranch        *b_Harm_FPP_Track_X;   //!
   TBranch        *b_Harm_FPP_Track_Y;   //!
   TBranch        *b_Harm_FPP_Track_Xp;   //!
   TBranch        *b_Harm_FPP_Track_Yp;   //!
   TBranch        *b_Harm_FPP_Track_T;   //!
   TBranch        *b_Harm_FPP_Track_P;   //!
   TBranch        *b_Harm_FPP_Track_Sx;   //!
   TBranch        *b_Harm_FPP_Track_Sy;   //!
   TBranch        *b_Harm_FPP_Track_Sz;   //!
   TBranch        *b_Harm_FPP_Track_Xfit;   //!
   TBranch        *b_Harm_FPP_Track_Yfit;   //!
   TBranch        *b_Harm_FPP_Track_Xpfit;   //!
   TBranch        *b_Harm_FPP_Track_Ypfit;   //!
   ...
   gep_tree_option1(TTree *tree=0);
   virtual ~gep_tree_option1();
...
#ifdef gep_tree_option1_cxx
gep_tree_option1::gep_tree_option1(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("gep_12GeV2_option1_60cm_job1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("gep_12GeV2_option1_60cm_job1.root");
      }
      f->GetObject("T",tree);
...
gep_tree_option1::~gep_tree_option1()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gep_tree_option1::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gep_tree_option1::LoadTree(Long64_t entry)
{
...
void gep_tree_option1::Init(TTree *tree)
{
   ...
   Harm_FPP_hit_plane = 0;
   Harm_FPP_hit_strip = 0;
   Harm_FPP_hit_x = 0;
   Harm_FPP_hit_y = 0;
   Harm_FPP_hit_z = 0;
   Harm_FPP_hit_polx = 0;
   ...
   Harm_FPP_hit_edep = 0;
   Harm_FPP_hit_beta = 0;
   Harm_FPP_Track_TID = 0;
   Harm_FPP_Track_PID = 0;
   Harm_FPP_Track_MID = 0;
   Harm_FPP_Track_NumHits = 0;
   Harm_FPP_Track_NumPlanes = 0;
   Harm_FPP_Track_NDF = 0;
   Harm_FPP_Track_Chi2fit = 0;
   Harm_FPP_Track_Chi2true = 0;
   Harm_FPP_Track_X = 0;
   Harm_FPP_Track_Y = 0;
   Harm_FPP_Track_Xp = 0;
   Harm_FPP_Track_Yp = 0;
   ...
   Harm_FPP_Track_Sy = 0;
   Harm_FPP_Track_Sz = 0;
   Harm_FPP_Track_Xfit = 0;
   Harm_FPP_Track_Yfit = 0;
   Harm_FPP_Track_Xpfit = 0;
   Harm_FPP_Track_Ypfit = 0;
   Harm_FT_hit_plane = 0;
   Harm_FT_hit_strip = 0;
   Harm_FT_hit_x = 0;
   Harm_FT_hit_y = 0;
   ...
   fChain->SetBranchAddress("Harm.FPP.hit.nhits", &Harm_FPP_hit_nhits, &b_Harm_FPP_hit_nhits);
   fChain->SetBranchAddress("Harm.FPP.hit.plane", &Harm_FPP_hit_plane, &b_Harm_FPP_hit_plane);
   fChain->SetBranchAddress("Harm.FPP.hit.strip", &Harm_FPP_hit_strip, &b_Harm_FPP_hit_strip);
   fChain->SetBranchAddress("Harm.FPP.hit.x", &Harm_FPP_hit_x, &b_Harm_FPP_hit_x);
   fChain->SetBranchAddress("Harm.FPP.hit.y", &Harm_FPP_hit_y, &b_Harm_FPP_hit_y);
   fChain->SetBranchAddress("Harm.FPP.hit.z", &Harm_FPP_hit_z, &b_Harm_FPP_hit_z);
   fChain->SetBranchAddress("Harm.FPP.hit.polx", &Harm_FPP_hit_polx, &b_Harm_FPP_hit_polx);
   fChain->SetBranchAddress("Harm.FPP.hit.poly", &Harm_FPP_hit_poly, &b_Harm_FPP_hit_poly);
   fChain->SetBranchAddress("Harm.FPP.hit.polz", &Harm_FPP_hit_polz, &b_Harm_FPP_hit_polz);
   fChain->SetBranchAddress("Harm.FPP.hit.t", &Harm_FPP_hit_t, &b_Harm_FPP_hit_t);
   fChain->SetBranchAddress("Harm.FPP.hit.trms", &Harm_FPP_hit_trms, &b_Harm_FPP_hit_trms);
   fChain->SetBranchAddress("Harm.FPP.hit.tmin", &Harm_FPP_hit_tmin, &b_Harm_FPP_hit_tmin);
   fChain->SetBranchAddress("Harm.FPP.hit.tmax", &Harm_FPP_hit_tmax, &b_Harm_FPP_hit_tmax);
   fChain->SetBranchAddress("Harm.FPP.hit.tx", &Harm_FPP_hit_tx, &b_Harm_FPP_hit_tx);
   fChain->SetBranchAddress("Harm.FPP.hit.ty", &Harm_FPP_hit_ty, &b_Harm_FPP_hit_ty);
   fChain->SetBranchAddress("Harm.FPP.hit.xin", &Harm_FPP_hit_xin, &b_Harm_FPP_hit_xin);
   fChain->SetBranchAddress("Harm.FPP.hit.yin", &Harm_FPP_hit_yin, &b_Harm_FPP_hit_yin);
   fChain->SetBranchAddress("Harm.FPP.hit.zin", &Harm_FPP_hit_zin, &b_Harm_FPP_hit_zin);
   fChain->SetBranchAddress("Harm.FPP.hit.xout", &Harm_FPP_hit_xout, &b_Harm_FPP_hit_xout);
   fChain->SetBranchAddress("Harm.FPP.hit.yout", &Harm_FPP_hit_yout, &b_Harm_FPP_hit_yout);
   fChain->SetBranchAddress("Harm.FPP.hit.zout", &Harm_FPP_hit_zout, &b_Harm_FPP_hit_zout);
   fChain->SetBranchAddress("Harm.FPP.hit.txp", &Harm_FPP_hit_txp, &b_Harm_FPP_hit_txp);
   fChain->SetBranchAddress("Harm.FPP.hit.typ", &Harm_FPP_hit_typ, &b_Harm_FPP_hit_typ);
   fChain->SetBranchAddress("Harm.FPP.hit.xg", &Harm_FPP_hit_xg, &b_Harm_FPP_hit_xg);
   fChain->SetBranchAddress("Harm.FPP.hit.yg", &Harm_FPP_hit_yg, &b_Harm_FPP_hit_yg);
   fChain->SetBranchAddress("Harm.FPP.hit.zg", &Harm_FPP_hit_zg, &b_Harm_FPP_hit_zg);
   fChain->SetBranchAddress("Harm.FPP.hit.trid", &Harm_FPP_hit_trid, &b_Harm_FPP_hit_trid);
   fChain->SetBranchAddress("Harm.FPP.hit.mid", &Harm_FPP_hit_mid, &b_Harm_FPP_hit_mid);
   fChain->SetBranchAddress("Harm.FPP.hit.pid", &Harm_FPP_hit_pid, &b_Harm_FPP_hit_pid);
   fChain->SetBranchAddress("Harm.FPP.hit.vx", &Harm_FPP_hit_vx, &b_Harm_FPP_hit_vx);
   fChain->SetBranchAddress("Harm.FPP.hit.vy", &Harm_FPP_hit_vy, &b_Harm_FPP_hit_vy);
   fChain->SetBranchAddress("Harm.FPP.hit.vz", &Harm_FPP_hit_vz, &b_Harm_FPP_hit_vz);
   fChain->SetBranchAddress("Harm.FPP.hit.p", &Harm_FPP_hit_p, &b_Harm_FPP_hit_p);
   fChain->SetBranchAddress("Harm.FPP.hit.edep", &Harm_FPP_hit_edep, &b_Harm_FPP_hit_edep);
   fChain->SetBranchAddress("Harm.FPP.hit.beta", &Harm_FPP_hit_beta, &b_Harm_FPP_hit_beta);
   fChain->SetBranchAddress("Harm.FPP.Track.ntracks", &Harm_FPP_Track_ntracks, &b_Harm_FPP_Track_ntracks);
   fChain->SetBranchAddress("Harm.FPP.Track.TID", &Harm_FPP_Track_TID, &b_Harm_FPP_Track_TID);
   fChain->SetBranchAddress("Harm.FPP.Track.PID", &Harm_FPP_Track_PID, &b_Harm_FPP_Track_PID);
   fChain->SetBranchAddress("Harm.FPP.Track.MID", &Harm_FPP_Track_MID, &b_Harm_FPP_Track_MID);
   fChain->SetBranchAddress("Harm.FPP.Track.NumHits", &Harm_FPP_Track_NumHits, &b_Harm_FPP_Track_NumHits);
   fChain->SetBranchAddress("Harm.FPP.Track.NumPlanes", &Harm_FPP_Track_NumPlanes, &b_Harm_FPP_Track_NumPlanes);
   fChain->SetBranchAddress("Harm.FPP.Track.NDF", &Harm_FPP_Track_NDF, &b_Harm_FPP_Track_NDF);
   fChain->SetBranchAddress("Harm.FPP.Track.Chi2fit", &Harm_FPP_Track_Chi2fit, &b_Harm_FPP_Track_Chi2fit);
   fChain->SetBranchAddress("Harm.FPP.Track.Chi2true", &Harm_FPP_Track_Chi2true, &b_Harm_FPP_Track_Chi2true);
   fChain->SetBranchAddress("Harm.FPP.Track.X", &Harm_FPP_Track_X, &b_Harm_FPP_Track_X);
   fChain->SetBranchAddress("Harm.FPP.Track.Y", &Harm_FPP_Track_Y, &b_Harm_FPP_Track_Y);
   fChain->SetBranchAddress("Harm.FPP.Track.Xp", &Harm_FPP_Track_Xp, &b_Harm_FPP_Track_Xp);
   fChain->SetBranchAddress("Harm.FPP.Track.Yp", &Harm_FPP_Track_Yp, &b_Harm_FPP_Track_Yp);
   fChain->SetBranchAddress("Harm.FPP.Track.T", &Harm_FPP_Track_T, &b_Harm_FPP_Track_T);
   fChain->SetBranchAddress("Harm.FPP.Track.P", &Harm_FPP_Track_P, &b_Harm_FPP_Track_P);
   fChain->SetBranchAddress("Harm.FPP.Track.Sx", &Harm_FPP_Track_Sx, &b_Harm_FPP_Track_Sx);
   fChain->SetBranchAddress("Harm.FPP.Track.Sy", &Harm_FPP_Track_Sy, &b_Harm_FPP_Track_Sy);
   fChain->SetBranchAddress("Harm.FPP.Track.Sz", &Harm_FPP_Track_Sz, &b_Harm_FPP_Track_Sz);
   fChain->SetBranchAddress("Harm.FPP.Track.Xfit", &Harm_FPP_Track_Xfit, &b_Harm_FPP_Track_Xfit);
   fChain->SetBranchAddress("Harm.FPP.Track.Yfit", &Harm_FPP_Track_Yfit, &b_Harm_FPP_Track_Yfit);
   fChain->SetBranchAddress("Harm.FPP.Track.Xpfit", &Harm_FPP_Track_Xpfit, &b_Harm_FPP_Track_Xpfit);
   fChain->SetBranchAddress("Harm.FPP.Track.Ypfit", &Harm_FPP_Track_Ypfit, &b_Harm_FPP_Track_Ypfit);
...
Bool_t gep_tree_option1::Notify()
{
...
void gep_tree_option1::Show(Long64_t entry)
{
...
Int_t gep_tree_option1::Cut(Long64_t entry)
{
...
#endif // #ifdef gep_tree_option1_cxx
