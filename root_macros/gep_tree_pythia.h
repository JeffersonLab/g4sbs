...
// Wed Feb 15 10:25:40 2023 by ROOT version 6.26/06
// from TTree T/Geant4 SBS Simulation
// found on file: Pythia_g4sbs_processed_E10p6GeV_proton_job1.root
//////////////////////////////////////////////////////////

#ifndef gep_tree_pythia_h
#define gep_tree_pythia_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   gep_tree_pythia(TTree *tree=0);
   virtual ~gep_tree_pythia();
...
#ifdef gep_tree_pythia_cxx
gep_tree_pythia::gep_tree_pythia(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("Pythia_g4sbs_processed_E10p6GeV_proton_job1.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("Pythia_g4sbs_processed_E10p6GeV_proton_job1.root");
      }
      f->GetObject("T",tree);
...
gep_tree_pythia::~gep_tree_pythia()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t gep_tree_pythia::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t gep_tree_pythia::LoadTree(Long64_t entry)
{
...
void gep_tree_pythia::Init(TTree *tree)
{
...
void gep_tree_pythia::Show(Long64_t entry)
{
...
Int_t gep_tree_pythia::Cut(Long64_t entry)
{
...
#endif // #ifdef gep_tree_pythia_cxx
