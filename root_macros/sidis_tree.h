...
// Thu Jun 10 09:58:58 2021 by ROOT version 6.24/00
// from TTree T/Geant4 SBS Simulation
// found on file: sidis_piplus_upbend_11gev.root
//////////////////////////////////////////////////////////
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        AUT_Collins;
   Double_t        AUT_Sivers;
   Double_t        AUT_Collins_min;
   Double_t        AUT_Collins_max;
   Double_t        AUT_Sivers_min;
   Double_t        AUT_Sivers_max;
   ...
   TBranch        *b_AUT_Collins;   //!
   TBranch        *b_AUT_Sivers;   //!
   TBranch        *b_AUT_Collins_min;   //!
   TBranch        *b_AUT_Collins_max;   //!
   TBranch        *b_AUT_Sivers_min;   //!
   TBranch        *b_AUT_Sivers_max;   //!
...
#ifdef sidis_tree_cxx
sidis_tree::sidis_tree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("sidis_piplus_upbend_11gev.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("sidis_piplus_upbend_11gev.root");
      }
      f->GetObject("T",tree);
...
sidis_tree::~sidis_tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t sidis_tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t sidis_tree::LoadTree(Long64_t entry)
{
...
void sidis_tree::Init(TTree *tree)
{
   ...
   fChain->SetBranchAddress("AUT_Collins", &AUT_Collins, &b_AUT_Collins);
   fChain->SetBranchAddress("AUT_Sivers", &AUT_Sivers, &b_AUT_Sivers);
   fChain->SetBranchAddress("AUT_Collins_min", &AUT_Collins_min, &b_AUT_Collins_min);
   fChain->SetBranchAddress("AUT_Collins_max", &AUT_Collins_max, &b_AUT_Collins_max);
   fChain->SetBranchAddress("AUT_Sivers_min", &AUT_Sivers_min, &b_AUT_Sivers_min);
   fChain->SetBranchAddress("AUT_Sivers_max", &AUT_Sivers_max, &b_AUT_Sivers_max);
...
void sidis_tree::Show(Long64_t entry)
{
...
Int_t sidis_tree::Cut(Long64_t entry)
{
