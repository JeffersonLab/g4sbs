...
// Wed Feb 22 09:08:11 2017 by ROOT version 6.08/02
// from TTree T/Geant4 SBS Simulation
// found on file: a1n_pythia6_n.root
//////////////////////////////////////////////////////////

#ifndef g4sbs_a1n_tree_h
#define g4sbs_a1n_tree_h
...
// Fixed size dimensions of array or collections stored in the TTree if any.
   ...
   Double_t        gen_Ebeam;
   Int_t           Earm_BBCal_hit_nhits;
   vector<int>     *Earm_BBCal_hit_row;
   vector<int>     *Earm_BBCal_hit_col;
   vector<int>     *Earm_BBCal_hit_cell;
   vector<int>     *Earm_BBCal_hit_plane;
   vector<double>  *Earm_BBCal_hit_xcell;
   vector<double>  *Earm_BBCal_hit_ycell;
   vector<double>  *Earm_BBCal_hit_zcell;
   vector<double>  *Earm_BBCal_hit_xcellg;
   vector<double>  *Earm_BBCal_hit_ycellg;
   vector<double>  *Earm_BBCal_hit_zcellg;
   vector<double>  *Earm_BBCal_hit_xhit;
   vector<double>  *Earm_BBCal_hit_yhit;
   vector<double>  *Earm_BBCal_hit_zhit;
   vector<double>  *Earm_BBCal_hit_sumedep;
   vector<double>  *Earm_BBCal_hit_tavg;
   vector<double>  *Earm_BBCal_hit_trms;
   vector<double>  *Earm_BBCal_hit_tmin;
   vector<double>  *Earm_BBCal_hit_tmax;
   ...
   TBranch        *b_ev;   //!
   TBranch        *b_gen;   //!
   TBranch        *b_Earm_BBCal_hit_nhits;   //!
   TBranch        *b_Earm_BBCal_hit_row;   //!
   TBranch        *b_Earm_BBCal_hit_col;   //!
   TBranch        *b_Earm_BBCal_hit_cell;   //!
   TBranch        *b_Earm_BBCal_hit_plane;   //!
   TBranch        *b_Earm_BBCal_hit_xcell;   //!
   TBranch        *b_Earm_BBCal_hit_ycell;   //!
   TBranch        *b_Earm_BBCal_hit_zcell;   //!
   TBranch        *b_Earm_BBCal_hit_xcellg;   //!
   TBranch        *b_Earm_BBCal_hit_ycellg;   //!
   TBranch        *b_Earm_BBCal_hit_zcellg;   //!
   TBranch        *b_Earm_BBCal_hit_xhit;   //!
   TBranch        *b_Earm_BBCal_hit_yhit;   //!
   TBranch        *b_Earm_BBCal_hit_zhit;   //!
   TBranch        *b_Earm_BBCal_hit_sumedep;   //!
   TBranch        *b_Earm_BBCal_hit_tavg;   //!
   TBranch        *b_Earm_BBCal_hit_trms;   //!
   TBranch        *b_Earm_BBCal_hit_tmin;   //!
   TBranch        *b_Earm_BBCal_hit_tmax;   //!
   ...
   g4sbs_a1n_tree(TTree *tree=0);
   virtual ~g4sbs_a1n_tree();
...
#ifdef g4sbs_a1n_tree_cxx
g4sbs_a1n_tree::g4sbs_a1n_tree(TTree *tree) : fChain(0) 
{
// if parameter tree is not specified (or zero), connect the file
// used to generate this class and read the Tree.
   if (tree == 0) {
      TFile *f = (TFile*)gROOT->GetListOfFiles()->FindObject("a1n_pythia6_n.root");
      if (!f || !f->IsOpen()) {
         f = new TFile("a1n_pythia6_n.root");
      }
      f->GetObject("T",tree);
...
g4sbs_a1n_tree::~g4sbs_a1n_tree()
{
   if (!fChain) return;
   delete fChain->GetCurrentFile();
}

Int_t g4sbs_a1n_tree::GetEntry(Long64_t entry)
{
// Read contents of entry.
   if (!fChain) return 0;
   return fChain->GetEntry(entry);
}
Long64_t g4sbs_a1n_tree::LoadTree(Long64_t entry)
{
...
void g4sbs_a1n_tree::Init(TTree *tree)
{
   ...
   // Set object pointer
   Earm_BBCal_hit_row = 0;
   Earm_BBCal_hit_col = 0;
   Earm_BBCal_hit_cell = 0;
   Earm_BBCal_hit_plane = 0;
   Earm_BBCal_hit_xcell = 0;
   Earm_BBCal_hit_ycell = 0;
   Earm_BBCal_hit_zcell = 0;
   Earm_BBCal_hit_xcellg = 0;
   Earm_BBCal_hit_ycellg = 0;
   Earm_BBCal_hit_zcellg = 0;
   Earm_BBCal_hit_xhit = 0;
   Earm_BBCal_hit_yhit = 0;
   Earm_BBCal_hit_zhit = 0;
   Earm_BBCal_hit_sumedep = 0;
   Earm_BBCal_hit_tavg = 0;
   Earm_BBCal_hit_trms = 0;
   Earm_BBCal_hit_tmin = 0;
   Earm_BBCal_hit_tmax = 0;
   ...
   fChain->SetBranchAddress("Earm.BBCal.hit.nhits", &Earm_BBCal_hit_nhits, &b_Earm_BBCal_hit_nhits);
   fChain->SetBranchAddress("Earm.BBCal.hit.row", &Earm_BBCal_hit_row, &b_Earm_BBCal_hit_row);
   fChain->SetBranchAddress("Earm.BBCal.hit.col", &Earm_BBCal_hit_col, &b_Earm_BBCal_hit_col);
   fChain->SetBranchAddress("Earm.BBCal.hit.cell", &Earm_BBCal_hit_cell, &b_Earm_BBCal_hit_cell);
   fChain->SetBranchAddress("Earm.BBCal.hit.plane", &Earm_BBCal_hit_plane, &b_Earm_BBCal_hit_plane);
   fChain->SetBranchAddress("Earm.BBCal.hit.xcell", &Earm_BBCal_hit_xcell, &b_Earm_BBCal_hit_xcell);
   fChain->SetBranchAddress("Earm.BBCal.hit.ycell", &Earm_BBCal_hit_ycell, &b_Earm_BBCal_hit_ycell);
   fChain->SetBranchAddress("Earm.BBCal.hit.zcell", &Earm_BBCal_hit_zcell, &b_Earm_BBCal_hit_zcell);
   fChain->SetBranchAddress("Earm.BBCal.hit.xcellg", &Earm_BBCal_hit_xcellg, &b_Earm_BBCal_hit_xcellg);
   fChain->SetBranchAddress("Earm.BBCal.hit.ycellg", &Earm_BBCal_hit_ycellg, &b_Earm_BBCal_hit_ycellg);
   fChain->SetBranchAddress("Earm.BBCal.hit.zcellg", &Earm_BBCal_hit_zcellg, &b_Earm_BBCal_hit_zcellg);
   fChain->SetBranchAddress("Earm.BBCal.hit.xhit", &Earm_BBCal_hit_xhit, &b_Earm_BBCal_hit_xhit);
   fChain->SetBranchAddress("Earm.BBCal.hit.yhit", &Earm_BBCal_hit_yhit, &b_Earm_BBCal_hit_yhit);
   fChain->SetBranchAddress("Earm.BBCal.hit.zhit", &Earm_BBCal_hit_zhit, &b_Earm_BBCal_hit_zhit);
   fChain->SetBranchAddress("Earm.BBCal.hit.sumedep", &Earm_BBCal_hit_sumedep, &b_Earm_BBCal_hit_sumedep);
   fChain->SetBranchAddress("Earm.BBCal.hit.tavg", &Earm_BBCal_hit_tavg, &b_Earm_BBCal_hit_tavg);
   fChain->SetBranchAddress("Earm.BBCal.hit.trms", &Earm_BBCal_hit_trms, &b_Earm_BBCal_hit_trms);
   fChain->SetBranchAddress("Earm.BBCal.hit.tmin", &Earm_BBCal_hit_tmin, &b_Earm_BBCal_hit_tmin);
   fChain->SetBranchAddress("Earm.BBCal.hit.tmax", &Earm_BBCal_hit_tmax, &b_Earm_BBCal_hit_tmax);
...
void g4sbs_a1n_tree::Show(Long64_t entry)
{
...
Int_t g4sbs_a1n_tree::Cut(Long64_t entry)
{
...
#endif // #ifdef g4sbs_a1n_tree_cxx
