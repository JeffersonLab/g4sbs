...
void G4SBSHArmBuilder::MakeRICH_new( G4LogicalVolume *motherlog, bool extended_snout){
  ...
  G4double snout_length = 100.0*cm;
  ...
  if(extended_snout)RICHbox_thick+=snout_length;
  //RICHbox_h = 10.0*m;
  ...
  if(extended_snout)origin.setZ(origin.z()+snout_length);
  ...
  if(extended_snout){
    ...
    G4Box *snoutbox = new G4Box("snoutbox", snout_width/2.0, snout_height/2.0, snout_length/2.0 );
    G4Box *snouthollow = new G4Box("snouthollow", snout_width/2.0-snout_thick, snout_height/2.0-snout_thick, snout_length/2.0+snout_thick );
    ...
    G4double snout_z0 = -0.75*mm - snout_length/2.0;
    ...
    //G4Box *snoutgas = new G4Box("snoutgas", snout_width/2.0-snout_thick, snout_height/2.0-snout_thick, snout_length/2.0);
  ...
  if(extended_snout)frontframe_pos.setZ(frontframe_pos.z()-snout_length);
  ...
  if(extended_snout)frontwindow_pos.setZ(frontwindow_pos.z()-snout_length);
  ...
  if(extended_snout)z0_RICH = z0_RICH-snout_length; 
