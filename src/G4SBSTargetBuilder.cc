...
void G4SBSTargetBuilder::BuildGEpScatCham(G4LogicalVolume *worldlog ){
  ...
  */
  ...
  if( fDetCon->fExpType != kGEPpositron ) new G4PVPlacement( rot_harm_window, Harm_window_pos, HarmWindow_log, "HarmWindow_phys", worldlog, false, 0, fChkOvLaps );
  ...
  if( fDetCon->fExpType != kGEPpositron ) new G4PVPlacement( rot_harm_window, HarmFlange_pos, HarmFlange_log, "HarmFlange_phys", worldlog, false, 0, fChkOvLaps );
  ...
  if( fDetCon->fExpType != kGEPpositron ) new G4PVPlacement( rot_earm_window, Earm_window_pos, EarmWindow_log, "EarmWindow_phys", worldlog, false, 0, fChkOvLaps );
  ...
  if( fDetCon->fExpType != kGEPpositron ) new G4PVPlacement( rot_earm_window, EarmFlange_pos, EarmFlange_log, "EarmFlange_phys", worldlog, false, 0, fChkOvLaps );
